report 50121 "SCSINV Credit Memo"
{

    // Created as copy of 1307, merged from 51000 (SCS Invoice)

    CaptionML = DEU = 'Verkauf - Gutschrift',
                ENU = 'SCS Sales - Credit Memo';
    DefaultLayout = RDLC;
    Permissions = TableData "Sales Shipment Buffer" = rimd;
    PreviewMode = PrintLayout;
    RDLCLayout = './SCS Credit Memo.rdl';
    WordLayout = './SCS Credit Memo.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            begin
                ...
                FormatAddr.SalesCrMemoBillTo(CustAddr, Header);

                if "Applies-to Doc. No." = '' then
                    AppliesToText := ''
                else
                    AppliesToText := StrSubstNo('%1 %2', "Applies-to Doc. Type", "Applies-to Doc. No.");
                ...
                //13.08.9 YSU +++
                //FormatAddr.SalesCrMemoShipTo(ShipToAddr, Header);
    ...
    var
        ...
        SalesCreditMemoNoLbl: TextConst DEU = 'Verkauf - Gutschrift %1', ENU = 'Sales - Credit Memo %1';
        ...
        InvNoLbl: TextConst DEU = 'Gutschriftsnr.', ENU = 'Credit Memo No.';
        ...
        SalesCreditMemoLbl: TextConst DEU = 'Gutschrift', ENU = 'Credit Memo';
        ...
        SalesPrepCreditMemoNoLbl: TextConst DEU = 'Verkauf - Vorauszahlungsgutschrift %1', ENU = 'Sales - Prepmt. Credit Memo %1';
        ...
        AppliesToText: Text;
        AppliesToTextLbl: TextConst DEU = 'Ausgleich mit Beleg', ENU = 'Applies to Document';
